...
type ConceptoAcademicoController struct {
	beego.Controller
}

// URLMapping ...
func (c *ConceptoAcademicoController) URLMapping() {
...
// @Param	body		body 	models.ConceptoAcademico	true		"body for ConceptoAcademico content"
// @Success 201 {int} models.ConceptoAcademico
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *ConceptoAcademicoController) Post() {
	var v models.ConceptoAcademico
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddConceptoAcademico(&v); err == nil {
...
// @Success 200 {object} models.ConceptoAcademico
// @Failure 404 not found resource
// @router /:id [get]
func (c *ConceptoAcademicoController) GetOne() {
...
// @Failure 404 not found resource
// @router / [get]
func (c *ConceptoAcademicoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *ConceptoAcademicoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *ConceptoAcademicoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
