...
type TipoPeriodoController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoPeriodoController) URLMapping() {
...
// @Param	body		body 	models.TipoPeriodo	true		"body for TipoPeriodo content"
// @Success 201 {int} models.TipoPeriodo
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoPeriodoController) Post() {
	var v models.TipoPeriodo
...
// @Success 200 {object} models.TipoPeriodo
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoPeriodoController) GetOne() {
...
// @Failure 404 not found resource
// @router / [get]
func (c *TipoPeriodoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoPeriodo(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *TipoPeriodoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *TipoPeriodoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
