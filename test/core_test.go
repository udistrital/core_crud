...
func iSendRequestToWhereBodyIsJson(method, endpoint, bodyreq string) error {
	...
	if method == "DELETE" {
		...
		ioutil.WriteFile("./files/res10/Ino.json", []byte(resDelete), 0644)
	}
	...
	if method == "POST" && resStatus == "201 Created" {
		...
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_area_conocimiento»\",\r\n"
		...
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_area_conocimiento\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res1/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_concepto_academico»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"concepto_academico\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_concepto_academico\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res2/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_grupo_investigacion»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"grupo_investigacion\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_grupo_investigacion\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res3/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_linea_investigacion»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"linea_investigacion\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_linea_investigacion\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res5/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_tipo_dato_adicional»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"tipo_dato_adicional\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_tipo_dato_adicional\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res8/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_tipo_periodo»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"tipo_periodo\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_tipo_periodo\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res9/Ierr8.json", []byte(resDuplex), 0644)

		resDuplex = "{\r\n\t\"Development\": null,\r\n\t\"Message\": \"The request contains incorrect syntax\",\r\n\t\"Status\": \"400\",\r\n\t\"System\": {\r\n"
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_unidad_tiempo»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"core_new\",\r\n\t\t\"Table\": \"unidad_tiempo\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_unidad_tiempo\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res10/Ierr8.json", []byte(resDuplex), 0644)
	}
	return nil
}
