...
Scenario Outline: To probe response route /tipo_periodo       
    ...
    |GET    |/v1/tipo_periodo |./files/req/Vacio.json |200 OK           |./files/res0/Vok2.json    |
    |POST   |/v1/tipo_periodo |./files/req/Vacio.json |400 Bad Request  |./files/res0/Ierr6.json   |
    |POST   |/v1/tipo_periodo |./files/req/Yt1.json   |201 Created      |./files/res0/Vok1.json    |
    |POST   |/v1/tipo_periodo |./files/req/Nt1.json   |400 Bad Request  |./files/res0/Ierr1.json   |
    |POST   |/v1/tipo_periodo |./files/req/Nt2.json   |400 Bad Request  |./files/res0/Ierr2.json   |
    ...
    |GETID  |/v1/tipo_periodo |./files/req/Yt1.json   |200 OK           |./files/res0/Vok1.json    |
    |DELETE |/v1/tipo_periodo |./files/req/Vacio.json |200 OK           |./files/res0/Ino.json     |
